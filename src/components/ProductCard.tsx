  ...
  return (
    <div className="card h-100 product-card">
      <div className="product-image-container">
        <img src={getImageUrl(image)} className="product-image" alt={title} />
      ...
      <div className="card-body">
        ...
        <div className="price-add-container">
          <div className="price">
            {discount ? (
              <>
                <span className="original-price">₹{Math.ceil(pricePerKg * parseFloat(selectedWeight.replace(/[^0-9.]/g, '')) / (selectedWeight.includes('g') ? 1000 : 1))}</span>
